...
The output files generated by this project are designed to be directly consumed by the **[osm-Spark Shortest Path-road-network](https://github.com/Khoshkhah/Spark-Shortest-Path)** project.
